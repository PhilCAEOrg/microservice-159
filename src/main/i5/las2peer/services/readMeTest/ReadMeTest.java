 ...
 *
 */
@ServicePath("readmetest")
@ManualDeployment
public class ReadMeTest extends RESTService {
  ...
  @SwaggerDefinition(
      info = @Info(title = "159", version = "$Metadata_Version$",
          ...
          license = @License(name = "BSD",
              url = "https://github.com/PhilCAEOrg/microservice-159/blob/master/LICENSE.txt") ) )
  @Path("/")
  public static class RootResource {

    private final ReadMeTest service = (ReadMeTest) Context.getCurrent().getService();
  ...
  @ApiOperation(value = "getRM", notes = " ")
