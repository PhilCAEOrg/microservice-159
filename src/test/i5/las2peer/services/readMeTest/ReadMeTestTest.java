 ...
 * 159 - Test Class
 *
 * This class provides a basic testing framework for the microservice 159. It was
...
public class ReadMeTestTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(ReadMeTest.class.getCanonicalName(),"0.1");

  private static final String mainPath = "readmetest";
  ...
  public void testgetRM() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "/readme", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testgetRM': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
